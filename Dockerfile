...
RUN sed -i 's/"rpc-whitelist": "127.0.0.1"/"rpc-whitelist": "*.*.*.*"/g' /.config/transmission-daemon
RUN sed -i 's|"rpc-host-whitelist": ".*",|"rpc-host-whitelist": "clod54-33mc03sz.b4a.run",|g' /.config/transmission-daemon
