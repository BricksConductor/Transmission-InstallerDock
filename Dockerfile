...
RUN sed -i 's/"rpc-username": "",/"rpc-username": "The-Bomber",/g' /etc/transmission-daemon/settings.json
RUN sed -i 's|"rpc-password": "{.*}",|"rpc-password": "{ihatebomber54@!}",|g' /etc/transmission-daemon/settings.json
